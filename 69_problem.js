...
function multiplicationTable(n) {
    ...
    for (let i = 1; i <= n; i++) {
        small = [];
        for (let j = 1; j <= n; j++) small.push(i * j);
        ar.push(small);
    }
    return ar;
}
console.log(JSON.stringify(multiplicationTable(1)) === JSON.stringify([[1]]));
console.log(
    JSON.stringify(multiplicationTable(3)) ===
        JSON.stringify([
            [1, 2, 3],
            [2, 4, 6],
            [3, 6, 9],
...
console.log(
    JSON.stringify(multiplicationTable(5)) ===
        JSON.stringify([
            [1, 2, 3, 4, 5],
            [2, 4, 6, 8, 10],
            [3, 6, 9, 12, 15],
...
console.log(
    JSON.stringify(multiplicationTable(20)) ===
        JSON.stringify([
            [
